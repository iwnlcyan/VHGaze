...
namespace RealisticEyeMovements {
	...
	public static class Utils
	{
		#region fields
			...
			static List<XRDisplaySubsystem> sXRDisplaySubsystems;
	    ...
	    public static bool IsVRDeviceConnected()
	    {
		    #if UNITY_2020_0_OR_NEWER || UNITY_2020_1_OR_NEWER
			    if ( sXRDisplaySubsystems == null )
			    {
				    sXRDisplaySubsystems = new List<XRDisplaySubsystem>();
			        SubsystemManager.GetSubsystems(sXRDisplaySubsystems);
			    }
			        
			    return sXRDisplaySubsystems.Count > 0;
			#else
	    ...
	    public static bool IsVRDeviceRunning()
	    {
		    #if UNITY_2020_0_OR_NEWER || UNITY_2020_1_OR_NEWER
			    if ( sXRDisplaySubsystems == null )
			    {
		        ...
		        foreach (XRDisplaySubsystem xrDisplay in sXRDisplaySubsystems)
